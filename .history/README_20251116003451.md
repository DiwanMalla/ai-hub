...
├── components/
│   ├── ModelTryPanel.tsx           # Browser-based inference UI
│   └── FiboPanel.tsx               # Text-to-image UI
├── app/
│   ├── page.tsx                    # Homepage
│   ├── models/[slug]/page.tsx      # Dynamic model pages
│   └── api/
│       ├── image-proxy/route.ts    # CORS proxy for remote images
│       ├── rmbg/route.ts           # RMBG server endpoint
│       └── fibo/route.ts           # FIBO inference endpoint
```
